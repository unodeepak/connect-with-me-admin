    ...
    <React.Fragment>
      ...
      <Row className="btn-page">
        <Col sm={12}>
          ...
          <Card>
            <Card.Header>
              <Button onClick={() => setIsBasic(!isBasic)} className="me-2" aria-controls="basic-collapse" aria-expanded={isBasic}>
                Collapse Link
              </Button>
              <Button onClick={() => setIsBasic(!isBasic)} className="me-2">
                Collapse Button
              </Button>
            </Card.Header>
            <Collapse in={isBasic}>
        ...
        <Col sm={12}>
          ...
          <Button onClick={multiTargetHandler} className="me-2">
